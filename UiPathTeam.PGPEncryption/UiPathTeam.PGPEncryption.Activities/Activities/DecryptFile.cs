...
{
    [LocalizedDisplayName(nameof(Resources.DecryptFile_DisplayName))]
    [LocalizedDescription(nameof(Resources.DecryptFile_Description))]
    public class DecryptFile : ContinuableAsyncNativeActivity
    {
        #region Properties
        ...
        [LocalizedDisplayName(nameof(Resources.DecryptFile_FileOut_DisplayName))]
        [LocalizedDescription(nameof(Resources.DecryptFile_FileOut_Description))]
        [LocalizedCategory(nameof(Resources.Output_Category))]
        [RequiredArgument]
        public OutArgument<string> FileOut { get; set; }

        [LocalizedDisplayName(nameof(Resources.DecryptFile_FileIn_DisplayName))]
        [LocalizedDescription(nameof(Resources.DecryptFile_FileIn_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        [RequiredArgument]
        public InArgument<string> FileIn { get; set; }

        [LocalizedDisplayName(nameof(Resources.DecryptFile_FilePrivateKey_DisplayName))]
        [LocalizedDescription(nameof(Resources.DecryptFile_FilePrivateKey_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        [RequiredArgument]
        public InArgument<string> FilePrivateKey { get; set; }

        [LocalizedDisplayName(nameof(Resources.DecryptFile_Passphrase_DisplayName))]
        [LocalizedDescription(nameof(Resources.DecryptFile_Passphrase_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        [OverloadGroup("Passphrase")]
        public InArgument<string> Passphrase { get; set; }

        [LocalizedDisplayName(nameof(Resources.DecryptFile_SecurePassphrase_DisplayName))]
        [LocalizedDescription(nameof(Resources.DecryptFile_SecurePassphrase_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        [OverloadGroup("SecurePassphrase")]
        public InArgument<SecureString> SecurePassphrase { get; set; }

        [LocalizedDisplayName(nameof(Resources.DecryptFile_Overwrite_DisplayName))]
        [LocalizedDescription(nameof(Resources.DecryptFile_Overwrite_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        public InArgument<bool> Overwrite { get; set; }

        [LocalizedDisplayName(nameof(Resources.DecryptFile_Result_DisplayName))]
        [LocalizedDescription(nameof(Resources.DecryptFile_Result_Description))]
        [LocalizedCategory(nameof(Resources.Output_Category))]
        public OutArgument<bool> Result { get; set; }

        [LocalizedDisplayName(nameof(Resources.DecryptFile_Status_DisplayName))]
        [LocalizedDescription(nameof(Resources.DecryptFile_Status_Description))]
        [LocalizedCategory(nameof(Resources.Output_Category))]
